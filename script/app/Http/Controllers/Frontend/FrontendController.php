...
class FrontendController extends Controller
{
    ...
    public function get_brand_with_product($limit=10)
    {
          ...
          public function all_blogs()
      {
            ...
            $userplan_id = DB::table('domains')->where('domain', $domain)->pluck('userplan_id')->first();
            if ($userplan_id) {
                  ...
                  if ($check) {
                        ...
                        $articles = Article::with('comments')->paginate($articles_per_page);
                         
                        
                        return view('frontend.bigbag.blog.all_blogs', compact('articles'));
                  } else {
                        abort(404);
                  }
            } else {
      ...
      public function view_blogs($slug)
      {
            ...
            if ($userplan_id) {
                  ...
                  if ($check) {
                        ...
                        return view('frontend.bigbag.blog.single_blog', compact('article', 'articles', 'blog_setting'));
                  } else {
                        abort(404);
                  }
            } else {
      ...
      public function Article_comment(Request $request)
      {
            ...
            $comment->article_id = $request->articel_id;
            $comment->save();
